...
exports.sendResetPasswordEmail = exports.logout = exports.login = exports.ResetPassword = void 0;
...
var sendResetPasswordEmail = (0, _catchAsync.default)(
/*#__PURE__*/
function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Failed to reset password! Try again.');
...
var ResetPassword = (0, _catchAsync.default)(
/*#__PURE__*/
function () {
  var _ref4 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee4(token, password, passwordConfirm) {
    var res;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js","../../utils/catchAsync":"../../utils/catchAsync.js"}],"mapbox.js":[function(require,module,exports) {
"use strict";
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGFyaWszMTAiLCJhIjoiY2xsb2J3aGl1MDd0cTNqcDMzNjI1ZDF6YiJ9.87W38N7hkREhR_Y3qLj72A';
  ...
  _regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'password' ? 'http://127.0.0.1:3000/api/v1/users/updatepassword' : 'http://127.0.0.1:3000/api/v1/users/updatemyprofile';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var stripe = Stripe('pk_test_51NjPllJ2OvdEbtEIZ5hfxPScMxF5XK5GXNlNa1EAjc26h5cej3VbUZlePvHLWPkuolTf0595Il0M1EqS6ZkPqRQf00iVvDcUgo');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error Creating review! Try again.');
...
function () {
  var _ref2 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee2(reviewId) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error deleting review! Try again.');
...
function () {
  var _ref3 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee3(reviewId, review, rating) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
        ...
        case 7:
          ...
          _context3.t0 = _context3["catch"](0);
          console.log(_context3.t0);
          (0, _alerts.showAlert)('error', 'Error updating review! Try again.');
...
var reviewForm = document.querySelector('.data_review_form');
...
var filterForm = document.querySelector('.form--filter'); // values
// ***********************************************************
...
if (reviewForm) {
  reviewForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var review = document.getElementById('reviewLabel').value;
    var rating = parseInt(document.getElementById('ratingLabel').value);
    var tourId = document.querySelector('.tour_review_form').dataset.tourId;
    var theReviewButton = document.querySelector("button[data-tour-id=\"".concat(tourId, "\"]"));
    var classNames = theReviewButton.classList;
    var classArray = Array.from(classNames);
    ...
    if (classArray[1] === 'update_review_btn') {
      var reviewId = theReviewButton.dataset.reviewId;
      (0, _review.updateReview)(reviewId, review, rating);
    }

    document.querySelector('.tour_review_form_container').style.display = 'none';
    theReviewButton.remove();
  });
}

var reviewDeletebtns = document.querySelectorAll('.delete_review_btn');

if (reviewDeletebtns) {
  reviewDeletebtns.forEach(function (button) {
    button.addEventListener('click', function (e) {
      e.preventDefault();
      var reviewId = e.target.dataset.reviewId;
      var reviewCard = document.getElementById("review-".concat(reviewId));
...
if (forgotPasswordForm) {
  forgotPasswordForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var email = document.getElementById('email').value;
    (0, _login.sendResetPasswordEmail)(email);
...
if (filterForm) {
  filterForm.addEventListener('submit', function (e) {
    ...
    var newQueryString = new URLSearchParams(queryParams).toString(); // Replace the current URL with the new URL containing the filtered query

    var newUrl = "".concat(window.location.pathname, "?").concat(newQueryString);
    window.history.replaceState({}, document.title, newUrl); // Reload the page
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var urlParams = new URLSearchParams(queryString); // Select the <select> elements and the input element

  var sortSelect = document.querySelector('#sort');
  var difficultySelect = document.querySelector('#difficulty');
  var durationInput = document.querySelector('#duration'); // Set the selected options based on query parameters

  var sortValue = urlParams.get('sort');
  var difficultyValue = urlParams.get('difficulty');
  var durationValue = urlParams.get('duration');

  if (sortSelect && sortValue) {
    // Set the selected option for sortSelect
    var sortOption = sortSelect.querySelector("option[value=\"".concat(sortValue, "\"]"));
  ...
  if (difficultySelect && difficultyValue) {
    ...
    var difficultyOption = difficultySelect.querySelector("option[value=\"".concat(difficultyValue, "\"]"));
